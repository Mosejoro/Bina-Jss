...
const sheetId = "1wE0KJlSkhaTFMTcjDj3t_rpp3SOHmn6hrSZeoIwcNzw"; // Replace with your Junior WAEC sheet ID
const sheetURL =
...
async function fetchQuestions(cls, subject) {
  if (!subject) {
    alert("Please select a subject.");
    return;
  }

  console.log("Fetching questions for:", { class: cls, subject });
...
function displayQuestions(data, subject, cls) {
  ...
  // Limit to 40 questions for Junior WAEC format
  ...
  for (let i = 0; i < limitedQuestionRows.length; i++) {
    ...
    questionsData.push({
      ...
      subject,
      cls,
      topic: categorizeQuestionByTopic(processedText, subject),
  ...
  questionsDiv.innerHTML = `
    <div class="results-container">
      ...
      <div class="results-summary">
        <p>Keep practicing consistently to improve your Junior WAEC performance.</p>
...
// Timer functionality
const examDuration = 45 * 60; // 45 minutes in seconds for Junior WAEC format
let timerInterval;
...
// Add this function to categorize questions by topic based on subject
function categorizeQuestionByTopic(questionText, subject) {
